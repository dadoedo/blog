 ...
 */
final class Version20231118160327 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE skill (id INT NOT NULL, name VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, seniority VARCHAR(255) DEFAULT NULL, months_active INT DEFAULT NULL, comment TEXT DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE job_post ADD CONSTRAINT FK_DD461ACC91BD8781 FOREIGN KEY (candidate_id) REFERENCES users (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
